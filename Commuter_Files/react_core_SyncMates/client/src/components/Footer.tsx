...
const Footer = () => {
  return (
    ...
    <footer className="text-gray-600 body-font">
      ...
      <div className="bg-gradient-to-br from-slate-600 to-pink-950">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src={logo} alt="" className='w-12' />
            <span className="ml-3 text-xl text-white">SyncMates</span>
          </a>
          <p className="text-sm text-gray-200 sm:ml-6 sm:mt-0 mt-4">© 2023 SyncMates —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-200 ml-1" target="_blank">@kunalshokeen99</a>
          </p>
